    ...
    if(Token::Verify($token,KEY)){
        ...
        switch ($method) {
            case 'GET':
                ...
                $query_validation ='SELECT * FROM STATUS_EMPLEADO';
            ...
            case 'POST':
                ...
                $query_post = " INSERT INTO STATUS_EMPLEADO(
                Nombre,
                FechaCreacion, 
                UsuarioCreacion
                ) 
            ...
            case 'PUT':
                ...
                $query_post = "UPDATE STATUS_EMPLEADO SET 
                Nombre = :nombre,
                FechaModificacion = :fechaHoraActual ,
                UsuarioModificacion = :IdUsuarioCreacion
                WHERE IdStatusEmpleado = :IdStatusUsuario";
                $stmt_post = $dbhost->prepare($query_post);
                $stmt_post->bindParam(':nombre', $nombre);
                $stmt_post->bindParam(':fechaHoraActual', $fechaHoraActual);
